...
import (
	...
	"github.com/agusheryanto182/go-rest-api-template/internal/controller/restapi"
	"github.com/agusheryanto182/go-rest-api-template/internal/repo/persistent"
	"github.com/agusheryanto182/go-rest-api-template/internal/usecase/user"
	"github.com/agusheryanto182/go-rest-api-template/pkg/httpserver"
	"github.com/agusheryanto182/go-rest-api-template/pkg/jwt"
	"github.com/agusheryanto182/go-rest-api-template/pkg/logger"
	"github.com/agusheryanto182/go-rest-api-template/pkg/postgres"
)
...
func initServers(cfg *config.Config, uc useCases, jwtManager *jwt.Manager, l logger.Interface) servers {
	...
	restapi.NewRouter(httpServer.App, cfg, uc.user, jwtManager, l)
